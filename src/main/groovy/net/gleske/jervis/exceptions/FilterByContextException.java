...
<pre><code>import net.gleske.jervis.exceptions.FilterByContextException
throw new FilterByContextException('some text')</code></pre><br>
 */
public class FilterByContextException extends JervisException {

    /**
      Throw a <tt>FilterByContextException</tt>.

      @param message A simple message.
     */
    public FilterByContextException(String message) {
        super(message);
    }
}
